...
> **状态日期：2026-07-19。** 当前收录 24 个公开项目。每个固定 Actions 链接都对应所列默认分支 HEAD；若项目上传 Actions Artifact，则保留 14 天；部分项目不上传构建产物，以项目条目为准。
...
- **构建证据：** [`85a508d55bf1`](https://github.com/rongyishuaige7/ESP32_RPS_Game/commit/85a508d55bf15422827a59276261f63739c836a8) · [Actions 成功](https://github.com/rongyishuaige7/ESP32_RPS_Game/actions/runs/29656135651)
- **真机状态：** 公开了 2026-07-18 提供的历史原理图导出；当前提交只完成静态检查和隔离构建，没有进行真机复测。
...
- **构建证据：** [`a367f3b11102`](https://github.com/rongyishuaige7/stm32-multisensor-data-acquisition/commit/a367f3b111024b97ab62981c87b58e10a1dca49f) · [Actions 成功](https://github.com/rongyishuaige7/stm32-multisensor-data-acquisition/actions/runs/29656153985)
- **真机状态：** 两张 2026-05-02 历史照片显示数据采集原型和界面；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`f4508a99157b`](https://github.com/rongyishuaige7/lora-warehouse-tracking-system/commit/f4508a99157bca19a3c2d55afda7884185ef2364) · [Actions 成功](https://github.com/rongyishuaige7/lora-warehouse-tracking-system/actions/runs/29656149273)
- **真机状态：** 2026-04-08 的历史照片显示 LoRa 标签/网关原型，并公开一份历史原理图；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`58c9bab197f1`](https://github.com/rongyishuaige7/adaptive-traffic-signal-system/commit/58c9bab197f1cc5bcdcce07f597d7c54062ce622) · [Actions 成功](https://github.com/rongyishuaige7/adaptive-traffic-signal-system/actions/runs/29656136601)
- **真机状态：** 2026-05-14 的桌面教学模型照片和历史仪表盘截图仅证明历史表面；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`1192c4f61442`](https://github.com/rongyishuaige7/esp32-s3-health-voice-terminal/commit/1192c4f6144280eee59dcfc81cd8ee7b4c456488) · [Actions 成功](https://github.com/rongyishuaige7/esp32-s3-health-voice-terminal/actions/runs/29656141551)
- **真机状态：** 2026-04-26 的历史照片显示终端原型；它不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`6179e5fab8c1`](https://github.com/rongyishuaige7/raspberry-pi-rfid-room-card-system/commit/6179e5fab8c1103fb3477a15369d75717bcfca6d) · [Actions 成功](https://github.com/rongyishuaige7/raspberry-pi-rfid-room-card-system/actions/runs/29656151724)
- **真机状态：** 仓库保留 2026-04-03 的四张已脱敏历史界面截图，本批新增一张 2026-04-08 历史实物照片；这些素材不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`75ac840d4c84`](https://github.com/rongyishuaige7/stm32-touch-gesture-control-system/commit/75ac840d4c8463673e2e859e7c26392dd6df0319) · [Actions 成功](https://github.com/rongyishuaige7/stm32-touch-gesture-control-system/actions/runs/29656155496)
- **真机状态：** 2026-04-02 的历史照片显示触摸/手势原型，并公开一份历史原理图；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`d183608bb929`](https://github.com/rongyishuaige7/esp32-smart-alarm-clock/commit/d183608bb9297fc1cc19f73cf1129e4144cff4d7) · [Actions 成功](https://github.com/rongyishuaige7/esp32-smart-alarm-clock/actions/runs/29656144651)
- **真机状态：** 2026-04-06 的历史原型/App 照片和历史 EDA 导出仅证明历史表面；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`dffd007a578b`](https://github.com/rongyishuaige7/esp32-smart-pillbox/commit/dffd007a578b26b3f3732d732cc9d8f0a2e2cc56) · [Actions 成功](https://github.com/rongyishuaige7/esp32-smart-pillbox/actions/runs/29656147110)
- **真机状态：** 2026-04-08 的历史照片显示智能药盒原型，并公开一份历史原理图；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`4d80a3bd1ee1`](https://github.com/rongyishuaige7/esp32-weather-clock/commit/4d80a3bd1ee13fc500467258a2923f83fcd47555) · [Actions 成功](https://github.com/rongyishuaige7/esp32-weather-clock/actions/runs/29656148143)
- **真机状态：** 2026-03-28 的历史照片显示天气时钟原型，并公开历史 EDA 导出；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`f2d0cf36adb7`](https://github.com/rongyishuaige7/esp32-s3-smart-safety-monitor/commit/f2d0cf36adb7cbc828a5b19a53ee1f167d140999) · [Actions 成功](https://github.com/rongyishuaige7/esp32-s3-smart-safety-monitor/actions/runs/29656143573)
- **真机状态：** 仅公开 2026-07-18 提供的历史 EDA 导出；其与当前源码存在舵机数量/引脚不一致，当前没有进行真机复测。
...
- **构建证据：** [`a25218a21a02`](https://github.com/rongyishuaige7/raspberry-pi-weather-station/commit/a25218a21a02c0cad7f029a266122fed53511d73) · [Actions 成功](https://github.com/rongyishuaige7/raspberry-pi-weather-station/actions/runs/29656153092)
- **真机状态：** 三张 2026-04-07 历史界面/日志截图显示历史软件界面；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`e5fa41b4d90e`](https://github.com/rongyishuaige7/esp32-baby-monitor/commit/e5fa41b4d90e21aa3ca5d618042cd589fb40c7ca) · [Actions 成功](https://github.com/rongyishuaige7/esp32-baby-monitor/actions/runs/29656138673)
- **真机状态：** 两张 2026-04-08 历史照片显示婴儿监测教学原型，并公开一份历史原理图；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`933d620355f8`](https://github.com/rongyishuaige7/esp32-beehive-monitor/commit/933d620355f8d729cbd5934940e97189873dc432) · [Actions 成功](https://github.com/rongyishuaige7/esp32-beehive-monitor/actions/runs/29656139471)
- **真机状态：** 公开了一张拍摄日期未知的历史原型照片和历史 EDA 导出；当前提交只完成静态检查和隔离构建，没有进行真机复测。
...
- **构建证据：** [`f732a2c26859`](https://github.com/rongyishuaige7/esp32-smart-makeup-cabinet/commit/f732a2c2685956c116916c2b92e60c680d88f22a) · [Actions 成功](https://github.com/rongyishuaige7/esp32-smart-makeup-cabinet/actions/runs/29656145890) · CI 不上传构建产物。
- **真机状态：** 2026-04-08 的历史原型照片和三张历史界面截图显示化妆柜教学原型；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`72fb4d9921f7`](https://github.com/rongyishuaige7/esp32-c3-smart-band/commit/72fb4d9921f757b022a0e8f9a03a4062ec871fcf) · [Actions 成功](https://github.com/rongyishuaige7/esp32-c3-smart-band/actions/runs/29656140601) · CI 不上传构建产物。
- **真机状态：** 2026-04-29 的历史照片显示手环教学原型，历史 EDA 也已公开；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`2a6dcf099d84`](https://github.com/rongyishuaige7/arduino-multisensor-audio-demo/commit/2a6dcf099d849ccb6203579343de7430803ed776) · [Actions 成功](https://github.com/rongyishuaige7/arduino-multisensor-audio-demo/actions/runs/29656137667) · CI 不上传构建产物。
- **真机状态：** 公开了一张拍摄日期未知的历史硬件照片；当前提交只完成静态检查和隔离构建，没有进行真机复测。
...
- **构建证据：** [`c98d461e0099`](https://github.com/rongyishuaige7/esp32-s3-smart-agriculture-monitoring-system/commit/c98d461e00992eb95e97a63abac63f5f00a1bf2f) · [Actions 成功](https://github.com/rongyishuaige7/esp32-s3-smart-agriculture-monitoring-system/actions/runs/29656142615) · CI 不上传构建产物。
- **真机状态：** 2026-03-24 的历史照片显示桌面农业监测教学原型，历史 EDA 也已公开；它们不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`bd392aa894e6`](https://github.com/rongyishuaige7/stm32f103-ov7670-smart-door-reminder-system/commit/bd392aa894e675eae3d58335ba74e18821e9d273) · [Actions 成功](https://github.com/rongyishuaige7/stm32f103-ov7670-smart-door-reminder-system/actions/runs/29636386247) · CI 不上传构建产物。
...
- **边界：** CI 不上传构建产物。 不含真人图像、人脸样本、身份模板、身份识别、图像落盘或网络服务。 构建和 CI 不证明烧录、OV7670、PIR、USB-TTL、SYN6288、扬声器、图像质量、串口端到端或电气安全。 不是门禁、门锁、安防、身份认证、人员追踪、可靠提醒、无人值守或生产系统。

### [基于ESP32和ILI9341的8键掌机界面教学原型](https://github.com/rongyishuaige7/esp32-ili9341-handheld-demo)

基于 ESP32、ILI9341 SPI 彩屏与 8 个按键的离线掌机界面教学 Demo，包含启动页、菜单、按键测试和方块移动。

- **平台：** ESP32 · Arduino · PlatformIO · ILI9341 · TFT_eSPI · 8 键 GPIO
- **构建证据：** [`ade1f0e54cf5`](https://github.com/rongyishuaige7/esp32-ili9341-handheld-demo/commit/ade1f0e54cf546c0b3fca674bb1947af45387f00) · [Actions 成功](https://github.com/rongyishuaige7/esp32-ili9341-handheld-demo/actions/runs/29639660261) · CI 不上传构建产物。
- **真机状态：** 公开范围扫描、仓库检查、7 项源码契约、ESP32 默认与背光 opt-in 编译已由 exact-HEAD CI 验证；当前 ESP32、ILI9341、8 个按键、背光、供电与完整交互尚未按当前公开提交重新真机复测。
- **公开范围：** 当前未公开实物照片、演示视频、原理图、PCB、EDA、Gerber 或制造文件；已公开固件、BOM、源码推导接线边界图、控制、来源、状态与验证说明。
- **边界：** CI 不上传构建产物。 默认不驱动 GPIO21 背光候选脚；GPIO5 参与 ESP32 启动配置，模块电压、逻辑电平、背光电流与供电必须按精确实物重新核对。 构建和 CI 不证明烧录、屏幕显示、按键动作、背光、供电、接线、稳定性或电气安全。 不是模拟器、ROM 分发、完整游戏机、消费电子、量产设计或生产系统。
...
- **构建证据：** [`7bbcd66e9d28`](https://github.com/rongyishuaige7/stm32f103-wardrobe-environment-monitoring-ventilation-system/commit/7bbcd66e9d28d0bdabce15296926c119c8146bff) · [Actions 成功](https://github.com/rongyishuaige7/stm32f103-wardrobe-environment-monitoring-ventilation-system/actions/runs/29656264221) · CI 不上传构建产物。
- **真机状态：** 2026-05-25 的历史照片显示衣柜监测原型；它不绑定当前提交，当前没有进行真机复测。
...
- **构建证据：** [`6d731dc17bb1`](https://github.com/rongyishuaige7/raspberry-pi-home-environment-activity-monitoring-demo/commit/6d731dc17bb1f401952a82b535eb553a32d23069) · [Actions 成功](https://github.com/rongyishuaige7/raspberry-pi-home-environment-activity-monitoring-demo/actions/runs/29656150545) · CI 不上传构建产物。
- **真机状态：** 2026-03-17 的历史照片显示教学原型；它不绑定当前提交，当前没有进行真机复测。
...
| 状态 | 含义 |
|:--|:--|
| 源码已确认 | 能力或引脚可由当前公开源码确认 |
| 构建已验证 | 当前默认分支在记录的 CI 中完成可复现构建 |
| 历史演示 | 日期化历史素材能证明画面中可见的原型表面，但不绑定当前提交 |
| 真机已复测 | 当前提交已在实物上按日期化清单重新验收 |

本轮 20 个素材项目只有 `仅历史证据` 或 `未复测`，没有任何项目被标记为 `真机已复测`；**没有进行真机复测**。
